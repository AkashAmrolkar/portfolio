        ...
        <div className="grid grid-cols-12 items-center gap-5">
          <div className="col-span-12 md:col-span-6">
            ...
            <div className="flex flex-wrap gap-5 items-center mb-8">
              <Link to='#contact' className="rounded-md bg-primary px-5 py-3 text-secondary font-semibold hover:text-secondary transition duration-300 ease-in-out transform hover:scale-105">Hire Me</Link>
